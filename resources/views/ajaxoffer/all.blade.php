        ...
        <tbody>
            ...
            @foreach ($offers as $offer)
                <tr class="offerRow{{ $offer->id }}">
                    ...
                    <td>
                        <a class="btn btn-success" href="{{ url('offers/edit/' . $offer->id) }}"role="button">{{ __('messages.update') }}</a>
                        ...
                        <a href="{{ route('ajax.offers.edit', $offer->id) }}"  class="btn btn-danger"> تعديل اجاكس</a>
                    </td>
